...
@implementation RLBubbleView
{
    UIImageView *_iconImageView;
    UILabel *_titleLabel;
    BOOL _isShowing;// 是否正在显示中
    NSMutableDictionary<NSString * , RLBubbleInfo *> *_infoDic;
    /// @brief 当前正在显示的泡泡信息对象
    RLBubbleInfo *_currentInfo;
    /// @brief 当前自定义动画绘图的图层
...
static  RLBubbleView*defaultBubbleView;
+ (RLBubbleView *)defaultBubbleView{
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        defaultBubbleView = [[RLBubbleView alloc] init];
    });
